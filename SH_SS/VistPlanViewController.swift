...
class VistPlanViewController: UIViewController,WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        var myURL : URL!
        if  jobtitle == "NVBHST" {
            myURL = URL(string:"http://mobileweb.sunhouse.com.vn/DMS/PCRoundVisitPlan?tokenkey=\(AccessToken)")
        }
        else
        {
            myURL = URL(string:"http://mobileweb.sunhouse.com.vn/SaleBussiness/SaleVistplan?tokenkey=\(AccessToken)")
        }
