//
//  ReportErrorForPGViewController.swift
//  SH_SS
//
...
class ReportErrorForPGViewController: UIViewController,ItemDelegate,TypeErrorDelegate,DayDelegate,UICollectionViewDataSource,UICollectionViewDelegate,
