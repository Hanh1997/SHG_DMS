//
//  ListSaleResultViewController.swift
//  SH_SS
//
...
import UIKit
class ListSaleResultViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        seachBar.placeholder = "Tìm kiếm tên sản phẩm"
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.infoValue.text = "TK:" + String(arrSeach[indexPath.row].StockQuantity) + "  "  + "TB:" +
            String(arrSeach[indexPath.row].ShowroomStock)
        return cell
    }
