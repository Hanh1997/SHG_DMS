...
class ImageReportViewController: UIViewController,UIImagePickerControllerDelegate ,UINavigationControllerDelegate ,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cellImg", for: indexPath) as! ImageReportCollectionViewCell
    ...
    {
        let cmp_wwn :String = UserDefaults.standard.string(forKey: "cmp_wwn") ?? ""
        if cmp_wwn.isEmpty
        {
