...
//  SH_SS
//
//  Created by phạm Hưng on 4/20/19.
...
class ReportImageViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        layout.itemSize = CGSize(width: (self.imgColectionView.frame.width ) / 2 , height: self.imgColectionView.frame.height / 2)
